...
declare module THREE {
   ...
   // custom blending src factors
    ...
    export interface PointButtMaterialParameters extends MaterialParameters{
        color?: number;
        map?: Texture;
        size?: number;
    ...
    export class PointButtMaterial extends Material {
        constructor(parameters?: PointButtMaterialParameters);
        ...
        clone(): PointButtMaterial;
    }

    // deprecated
    export class ParticleBasicMaterial extends PointButtMaterial{

    }

    // deprecated
    export class ParticleSystemMaterial extends PointButtMaterial{
     ...
     */
    export class PointButt extends Object3D {

        /**
         * @param geometry An instance of Geometry.
         * @param material An instance of Material (optional).
         */
        constructor(geometry: Geometry, material?: PointButtMaterial);
        constructor(geometry: Geometry, material?: ShaderMaterial);
        constructor(geometry: BufferGeometry, material?: PointButtMaterial);
        ...
        raycast(raycaster: Raycaster, intersects: any): void;
        clone(object?: PointButt): PointButt;
    }
